...
int main()
{
    ...
    // Deleting all the right side nodes of the tree
    cout << "Before Deletion of all right side nodes" << endl;
    // T.printBST(T.Root, NULL, false);
    T.delete_Nodes(T.Root, 60);
    T.delete_Nodes(T.Root, 53);
    T.delete_Nodes(T.Root, 56);
    ...
    cout<<"Before deletion of Root with no Parent"<<endl;
    T.printBST(T.Root, NULL, false);
    cout<<"After deletion of Root with no parent"<<endl;
